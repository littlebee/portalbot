            ...
            <div className={styles.card}>
                ...
                {loading ? (
                    ...
                    <div className={styles.error}>
                        ...
                        <p className={styles.helpText}>
                            Please check that the server is running and try
                            again.
                        </p>
                    </div>
                ) : enabledSpaces.length === 0 ? (
                    <p className={styles.helpText}>
                        No spaces are currently available. Please check back
                        later.
                    </p>
                ) : (
                    <>
                            ...
                            {enabledSpaces.map((space) => (
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        />
                                        <div
                                            className={styles.spaceCardContent}
                                        >
                                            <h3
                                                className={
                                            ...
                                            <p
                                                className={
                                                    styles.spaceCardParticipants
                                                }
                                            >
                                                Max {space.max_participants}{" "}
                                                participants
                                            </p>
                                        </div>
                                        {joiningSpaceId === space.id && (
                        ...
                        <p className={styles.helpText}>
                            Click on a space to join. Share the space name with
                            your peer to connect together.
                        </p>
                    </>
                )}
            </div>
